...
import { Check, Search, Tally4 } from 'lucide-react';
    ...
    <div className="absolute bottom-4 left-4 p-2 bg-white bg-opacity-70 rounded shadow text-sm">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center gap-0.5">
          ...
          <span className="font-medium">{Math.round(camera.zoom * 100)}%</span>
        </div>
      ...
      {selectedItems.length === 1 && (
        <div className="mt-1 pt-1 border-t border-gray-200 text-xs">
          ...
          <span className="text-gray-600 font-mono">{selectedItems[0].objid.substring(0, 8)}...</span>
